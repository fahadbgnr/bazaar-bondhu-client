...
const AdvertisementsPage = () => {
    ...
    const handleUpdateAd = async (data) => {
        try {
            const adData = {
                ...selectedAd,
                ...data,
                vendorEmail: user.email, // ✅ Include this for authorization check
            };
    ...
    const handleDeleteAd = async () => {
        try {
            // ✅ Send vendorEmail in query param
    ...
    return (
        <div className="max-w-6xl mx-auto py-10 px-5">
            ...
            <div className="overflow-x-auto">
                {loading ? (
                    <p className="text-center py-10">Loading advertisements...</p>
                ) : (
            ...
            {showDeleteModal && selectedAd && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
                    <motion.div
                        ...
                        className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 space-y-6 relative"
                    >
                        {/* Close (X) button */}
                        <button
                            onClick={() => {
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">
                                ...
                                <span className="font-semibold text-red-600">"{selectedAd.title}"</span>?
                            </p>
                        </div>
