...
const UpdateProduct = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.error('❌ Failed to update product.', { position: 'top-right', autoClose: 3000 });
    }
  };

  return (
    <motion.div
      className="w-full max-w-3xl mx-auto p-8 rounded-xl shadow-lg py-10 my-12 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
      initial={{ opacity: 0, scale: 0.95 }}
      animate={{ opacity: 1, scale: 1 }}
      transition={{ duration: 0.5 }}
    >
      <Helmet>
        <title>BB | Update Product</title>
      </Helmet>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            value={user?.email}
            readOnly
            className="input input-bordered w-full bg-gray-100 dark:bg-gray-700 dark:text-gray-100"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="input input-bordered w-full bg-white dark:bg-gray-800 dark:text-gray-100"
          />
        ...
        <div>
          ...
          <textarea
            ...
            className="textarea textarea-bordered w-full bg-white dark:bg-gray-800 dark:text-gray-100"
          />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="btn btn-sm bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white"
            >
              Add
            </button>
          </div>
          ...
          {priceHistory.length > 0 && (
            <ul className="mt-3 space-y-1">
              {priceHistory.map((item, index) => (
                <li
                  key={index}
                  className="flex items-center justify-between bg-green-50 dark:bg-green-800 px-3 py-2 rounded"
                >
                  <span>
                  ...
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-200 text-sm"
                  >
                    Remove
                  </button>
                </li>
        ...
        <button
          type="submit"
          className="btn bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-semibold w-full"
        >
          Update Product
        </button>
      </form>
