...
const PriceTrendChart = () => {
  ...
  return (
    <motion.div
      className="max-w-6xl mx-auto mt-10 p-4 sm:p-6 md:p-8 bg-white rounded-2xl shadow-lg"
      ...
      <div className="flex flex-col md:flex-row gap-6 my-10">
        ...
        <div className="md:w-3/4">
          <div className="flex items-center gap-2 mb-4">
            <h3 className="text-lg sm:text-xl font-semibold capitalize text-slate-800">{itemName}</h3>
          </div>
          ...
          <motion.p className={`mt-4 font-semibold ${trendColor}`}
