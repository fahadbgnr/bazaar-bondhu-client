...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-4xl mx-auto p-6 bg-green-50 rounded shadow-md my-10">
            <Helmet>
                <title>
                    BB|PrivacyPolicy
                </title>
            ...
            <p className="mb-4">
                The information we collect is used to provide, maintain, and improve our services, respond to inquiries, and communicate important updates.
            </p>
            ...
            <p className="mb-4">
                We may share your information with trusted third-party service providers to help operate our business. They are obligated to keep your information confidential.
            </p>

            <h2 className="text-xl font-semibold mb-3">6. Your Rights</h2>
            <p className="mb-4">
                You have the right to access, update, or delete your personal information. For any privacy-related requests, please contact us.
            </p>
